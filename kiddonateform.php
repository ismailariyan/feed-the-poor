...
if(isset($_POST['submit']))
{
    ...
    $query="insert into kid_donate(email,category,phoneno,location,address,name,quantity) values('$emailid','$category','$phoneno','$district','$address','$name','$quantity')";
    ...
    try {
        ...
        $mail->Body    = "
            <p>Dear $name,</p>
            <p>Thank you for helping kids in need with their education. Here are the details of your donation:</p>
    ...
    header("location:generatepdfforkid.php");
}
?>
            ...
            <form action="" method="post">
                ...
                <div class="input">
                    ...
                    <div class="image-radio-group">
                        <input type="radio" id="gorur-tehari" name="image-choice" value="Books" required>
                        <label for="gorur-tehari">
                            <img src="" alt="Books">
                        </label>
                        <input type="radio" id="khicuri" name="image-choice" value="School Uniforms" checked>
                        <label for="khicuri">
                            <img src="" alt="School Uniforms">
                        </label>
                        <input type="radio" id="daal-vaaat" name="image-choice" value="Educational Toys ">
                        <label for="daal-vaaat">
                            <img src="" alt="Educational Toys ">
                        </label>
                    </div>
                    <br>
                </div>
